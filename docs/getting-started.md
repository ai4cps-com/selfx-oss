...
Each example shows the minimal code required and the resulting dashboard output.
...
This example shows a slightly more realistic scenario using conveyor data.
